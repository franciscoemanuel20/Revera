...
const CATALOGO_GUIADO_COPY: Record<SiteLocale, {
  ...
  fr: {
    filtros: [
      { id: "todas", rotulo: "Toutes" },
      { id: "lisa", rotulo: "Lisse" },
      { id: "cacheada", rotulo: "Bouclee" },
      { id: "crespa", rotulo: "Frisee" },
      { id: "afro", rotulo: "Afro" },
    ],
    textura: { lisa: "Lisse", cacheada: "Bouclee", crespa: "Frisee", afro: "Afro" },
    valor: {
    ...
    titulo: "Comparer par texture",
    intro: "Chaque piece indique a qui elle convient avant d'ouvrir les details.",
    filtroAria: "Filtrer les produits par texture",
    vazioFiltro: "Nous n'avons pas encore de piece publiee pour cette texture.",
    guiaEyebrow: "Choisir avec confiance",
    guiaTitulo: "Vous ne savez pas quelle prothese choisir ?",
    guiaIntro: "Repondez a trois questions rapides et voyez la piece la plus proche de ce que vous cherchez.",
    abrir: "Trouver ma piece",
    fechar: "Fermer le guide",
    perguntaTextura: "1. Quelle texture cherchez-vous ?",
    perguntaPrioridade: "2. Qu'est-ce qui compte le plus pour vous ?",
    perguntaPrimeira: "3. Est-ce votre premiere piece ?",
    frente: "Ligne frontale plus discrete",
    equilibrio: "Equilibre au quotidien",
    fixacao: "Fixation plus sure",
    texturaIndicacao: "Pour cette texture, nous recommandons le modele adapte a cette finition.",
    escolhaPrimeiro: "Choisissez d'abord la texture.",
    primeiraSim: "Oui, je veux un choix simple",
    primeiraNao: "Non, je sais deja ce que je cherche",
    nossaIndicacao: "Notre recommandation :",
    verPeca: "Voir cette piece",
    valueLabelFixacao: "Fixation",
    valueLabelNatural: "Finition naturelle",
  },
  de: {
    filtros: [
      { id: "todas", rotulo: "Alle" },
      { id: "lisa", rotulo: "Glatt" },
      { id: "cacheada", rotulo: "Lockig" },
      { id: "crespa", rotulo: "Kraus" },
      { id: "afro", rotulo: "Afro" },
    ],
    textura: { lisa: "Glatt", cacheada: "Lockig", crespa: "Kraus", afro: "Afro" },
    valor: {
    ...
    titulo: "Nach Textur vergleichen",
    intro: "Jedes System zeigt vor den Details, fur wen es geeignet ist.",
    filtroAria: "Produkte nach Textur filtern",
    vazioFiltro: "Fur diese Textur ist noch kein System veroffentlicht.",
    guiaEyebrow: "Sicher auswahlen",
    guiaTitulo: "Nicht sicher, welches Haarsystem passt?",
    guiaIntro: "Beantworten Sie drei kurze Fragen und sehen Sie das System, das am besten passt.",
    abrir: "Mein System finden",
    fechar: "Guide schliessen",
    perguntaTextura: "1. Welche Textur suchen Sie?",
    perguntaPrioridade: "2. Was ist Ihnen am wichtigsten?",
    perguntaPrimeira: "3. Ist es Ihr erstes System?",
    frente: "Diskretere Front",
    equilibrio: "Balance fur den Alltag",
    fixacao: "Sichererer Halt",
    texturaIndicacao: "Fur diese Textur empfehlen wir das Modell mit passendem Finish.",
    escolhaPrimeiro: "Wahlen Sie zuerst die Textur.",
    primeiraSim: "Ja, ich mochte eine einfache Wahl",
    primeiraNao: "Nein, ich weiss, was ich suche",
    nossaIndicacao: "Unsere Empfehlung:",
    verPeca: "Dieses System ansehen",
    valueLabelFixacao: "Halt",
    valueLabelNatural: "Naturliches Finish",
  },
};
