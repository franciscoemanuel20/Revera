-- ===========================================================================
-- REVERÁ — migrations 4 a 7, numa colagem só.
--
-- Gerado a partir de supabase/migrations/. Não edite este arquivo: é cópia
-- de conveniência. A fonte são os arquivos numerados.
--
-- COMO USAR: Supabase → SQL Editor → cole tudo → Run.
-- Ou, melhor: npm run db:aplicar (ver scripts/aplicar-migrations.mjs).
--
-- Rodar de novo não faz mal: tudo aqui é idempotente.
--
--   4 — balde privado das fotos de "não sei qual cor escolher"
--   5 — deixa o admin logado enxergar pedidos, clientes e envios
--   6 — impede etiqueta duplicada (cada uma é paga na hora)
--   7 — atribuição: de onde veio quem comprou, e o log de conversões
-- ===========================================================================
